...
<head>
    ...
    <script type="text/javascript" src="./js/scp.js?ecb4f89"></script>
    <script type="text/javascript" src="<?php echo ROOT_PATH; ?>js/jquery.pjax.js?ecb4f89"></script>
    ...
    <script type="text/javascript" src="./js/bootstrap-typeahead.js?ecb4f89"></script>
    <link rel="stylesheet" href="<?php echo ROOT_PATH ?>css/thread.css?ecb4f89" media="all">
    <link rel="stylesheet" href="./css/scp.css?ecb4f89" media="all">
    <link rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/redactor.css?ecb4f89" media="screen">
    <link rel="stylesheet" href="./css/typeahead.css?ecb4f89" media="screen">
    ...
    <!--[if IE 7]>
    <link rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/font-awesome-ie7.min.css?ecb4f89">
    <![endif]-->
    <link type="text/css" rel="stylesheet" href="./css/dropdown.css?ecb4f89">
    <link type="text/css" rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/loadingbar.css?ecb4f89"/>
    <link type="text/css" rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/rtl.css?ecb4f89"/>
    <script type="text/javascript" src="./js/jquery.dropdown.js?ecb4f89"></script>
