...
define('SECRET_SALT','e7wCKzVXUB0DzgoXMTHoDUF-eQ51n1rp');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','conrad@devlabtech.com');
...
define('DBNAME','ostickets');
define('DBUSER','lockwoodtickets');
define('DBPASS','colonelmagic');
